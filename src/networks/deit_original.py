...
@register_model
def deit_small_distilled_patch16_224_cil(pretrained=False, **kwargs) -> VisionTransformerDistilled:
...
@register_model
def deit_base_distilled_patch16_224_cil(pretrained=False, **kwargs) -> VisionTransformerDistilled:
