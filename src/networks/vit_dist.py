...
@register_model
def vit_base_patch16_224_dist(pretrained=False, **kwargs):
    """ViT-Base (orig_in21k) backbone + randomly-initialized dist_token."""
...
@register_model
def vit_base_patch16_224_dist_in1k(pretrained=False, **kwargs):
    """ViT-Base (augreg_in1k) backbone + randomly-initialized dist_token."""
    model_args = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12)
    model = build_model_with_cfg(
        VisionTransformerDistilledCIL,
