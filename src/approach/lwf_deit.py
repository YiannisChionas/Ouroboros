...
class Appr(Incremental_Learning_Approach):
    ...
    def _get_optimizer(self):
        ...
        params = list(self.model.model.parameters()) + list(self.model.heads[-1].parameters())+ list(self.model.heads_dist[-1].parameters())
    ...
    def post_train_process(self, t, trn_loader):
        ...
        self.model_old.eval()
        self.model_old.model.set_distilled_training(enable=False)
