#!/usr/bin/env python3
"""Mini-pretraining of VitHydra_v2 MLP heads using four teacher networks.
...
Usage:
  python pretrain_vit_hydra_v2.py --data /opt/storage/datasets/imagenet1k --output mlp_weights_v2.pth
"""
...
from networks.vit_hydra_v2 import VitHydra_v2
...
def main():
    ...
    parser.add_argument('--output',      default='mlp_weights_v2.pth')
    ...
    model = VitHydra_v2(backbone, teacher_out_dim=1000).to(device)
