#!/bin/bash
#SBATCH --job-name=encoder_decoder_test_v2_cifar100_vit_small_in1k_dist
...
CONDA_ENV="test_env"
CONFIG="${PROJECT_DIR}/configs/vit_small_in1k_dist/cifar100/encoder_decoder_test_v2.json"
